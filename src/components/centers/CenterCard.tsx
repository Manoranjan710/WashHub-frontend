    ...
    <article className="bg-white rounded-2xl border border-aqua-100/70 shadow-[0_4px_20px_rgba(0,95,115,0.09)] hover:shadow-[0_10px_36px_rgba(0,95,115,0.17)] hover:-translate-y-1 transition-all duration-200 flex flex-col">
      ...
      <div className="bg-deepsea-600 rounded-t-2xl px-5 pt-5 pb-4 border-b border-deepsea-500/20">
        <div className="flex items-start justify-between gap-2">
          <h2 className="text-white font-semibold text-lg leading-snug">{center.name}</h2>
        ...
        <p className="text-arctic-100 text-sm mt-1 line-clamp-2">{center.address}</p>
      </div>
      ...
      <div className="px-5 pb-5">
        <Link
          href={href}
          className="block w-full text-center bg-deepsea-600 hover:bg-deepsea-700 active:scale-[0.98] text-white font-medium py-2.5 rounded-xl shadow-md hover:shadow-md transition-all duration-150 text-sm"
        >
          View &amp; Book
        </Link>
      </div>
